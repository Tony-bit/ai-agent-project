...
public interface IAiClientModelDao {
    ...
    /**
     * 插入聊天模型配置
     * @param AiClientModelPO 聊天模型配置对象
     * @return 影响行数
     */
    int insert(AiClientModelPO AiClientModelPO);
     ...
     * @return 影响行数
     */
    int updateById(AiClientModelPO AiClientModelPO);
     ...
     * @return 影响行数
     */
    int updateByModelId(AiClientModelPO AiClientModelPO);
