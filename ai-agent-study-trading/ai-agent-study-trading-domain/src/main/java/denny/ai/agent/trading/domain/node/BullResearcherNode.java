...
public class BullResearcherNode extends AbstractExecuteSupport {
    ...
    public NarrativeNodeResult prepare(TradingContextVO context,
        ...
        try {
            ...
            log.error("节点执行异常: nodeName=BullResearcherNode, ticker={}", tickerOf(context), error);
            throw error;
        }
    }
    ...
    private NarrativeNodeResult generateBullThesis(TradingContextVO context,
        ...
        String prompt = rolePromptService.render("6006", context, dynamicContext,
        ...
        log.debug("LLM streaming input | operation=BullResearcherNode | content=\n{}", prompt);
