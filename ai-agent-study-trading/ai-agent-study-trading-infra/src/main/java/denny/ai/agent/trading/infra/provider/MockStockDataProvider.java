    ...
    public FundamentalDataVO getFundamentalData(String ticker) {
        return switch (ticker.toUpperCase()) {
            case "NVDA" -> FundamentalDataVO.builder()
                    ...
                    .roe(0.638).roa(0.295).grossMargin(0.745).netMargin(0.529)
                    ...
                    .revenueGrowth(0.125).earningsGrowth(0.185).netIncomeGrowth(0.176)
                    .operatingCashFlow(BigDecimal.valueOf(36_486)).freeCashFlow(BigDecimal.valueOf(32_244))
                    .debtToEquity(0.44).currentRatio(4.13)
            ...
            case "AAPL" -> FundamentalDataVO.builder()
                    ...
                    .roe(1.567).roa(0.242).grossMargin(0.469).netMargin(0.242)
                    ...
                    .revenueGrowth(0.040).earningsGrowth(0.115).netIncomeGrowth(0.114)
                    .operatingCashFlow(BigDecimal.valueOf(118_254)).freeCashFlow(BigDecimal.valueOf(96_543))
                    .debtToEquity(1.87).currentRatio(0.99)
            ...
            case "TSLA" -> FundamentalDataVO.builder()
                    ...
                    .roe(0.243).roa(0.089).grossMargin(0.177).netMargin(0.152)
                    ...
                    .revenueGrowth(0.030).earningsGrowth(-0.230).netIncomeGrowth(-0.239)
                    .operatingCashFlow(BigDecimal.valueOf(13_251)).freeCashFlow(BigDecimal.valueOf(2_064))
                    .debtToEquity(0.17).currentRatio(1.86)
            ...
            default -> FundamentalDataVO.builder()
                    ...
                    .roe(0.15).roa(0.08).grossMargin(0.35).netMargin(0.10)
                    ...
                    .revenueGrowth(0.05).earningsGrowth(0.08).netIncomeGrowth(0.07)
