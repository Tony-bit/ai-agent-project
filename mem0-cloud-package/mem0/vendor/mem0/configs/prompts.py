...
# =============================================================================
# Persona (User Profile) Prompts
# =============================================================================

PERSONA_EXTRACTION_PROMPT = """从记忆提取用户画像，返回纯JSON：

{{"user_name":"名字","occupation":"职业","personality":["特点1","特点2"],"preferences":{{"爱好":"偏好"}},"communication_style":"沟通风格","skills":["技能1","技能2"]}}

注意：直接输出JSON，不要其他内容，不要markdown代码块。
...
PERSONA_TEXT_GENERATION_PROMPT = """你是一个人物画像总结专家。基于提取的人物属性，生成一段自然语言的人物画像文本。

【要求】
- 使用中文
- 总长度不超过 2000 tokens（约 1500-2000 中文字符）
- 格式：连贯的自然语言段落
- 风格：客观、简洁、信息密度高
- 包含所有提取到的属性
